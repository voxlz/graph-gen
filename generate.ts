...
//
// Usage:
//   tsx generate.ts <input1> <output1> [<input2> <output2> ...]
//
// Example:
//   tsx generate.ts demo/usecases/bookstore_uc1.txt out/bookstore_uc1.png \
...
if (args.length === 0 || args.length % 2 !== 0) {
  console.error(
    "Usage: tsx generate.ts <input1> <output1> [<input2> <output2> ...]",
  );
  process.exit(1);
}
